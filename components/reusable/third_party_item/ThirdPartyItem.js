...
function ThirdPartyItem({ item }) {
  return (
    <div className={thirdPartyItemStyles.itemContainer}>
      ...
      <div className={thirdPartyItemStyles.textContainer}>
        <h3>Đặt hàng ngay thông qua ứng dụng ABC</h3>
        <p className={thirdPartyItemStyles.descText}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore soluta totam autem, adipisci reiciendis aperiam quasi! Sit, similique quod. Voluptatum amet ducimus et temporibus officia id omnis necessitatibus nobis vitae!</p>
